...
export async function fetch_followers(username) {
  const followersResponse = await fetch(`api/followers/${username}/followers`, {
    credentials: "include",
  });
...
export async function fetch_following(username) {
  const followingResponse = await fetch(`api/followers/${username}/following`, {
    credentials: "include",
  });
...
export async function fetch_banana_count(users) {
  const response = await fetch(`api/bananas/get-bananas`, {
    method: "POST",
    headers: {
...
export async function post_banana_count(count) {
  await fetch(`api/bananas/post-bananas`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function post_banana_history(amount) {
  await fetch(`api/banana-history/post-history`, {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
...
export async function fetch_banana_history(following) {
  let response = await fetch(`api/banana-history/get-history`, {
    method: "POST",
    credentials: "include",
    headers: { "Content-Type": "application/json" },
...
export async function post_friend_requests(sender, receiver) {
  ...
  await fetch(
    `api/friend-requests/send-requests`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
...
export async function remove_friend_requests(sender, receiver) {
  await fetch(
    `api/friend-requests/remove-requests`,
    {
      method: "DELETE",
      headers: {
        "Content-Type": "application/json",
...
export async function fetch_friend_requests(username) {
  let data = await fetch(
    `api/friend-requests/get-requests?username=${username}`
  );
...
export async function postResetPasswordLink(email) {
  await fetch(`api/auth/forgot-password-link`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function fetchPasswordReset(token) {
  const response = await fetch(`api/auth/get-reset-password?token=${token}`, {
    method: "GET",
  });
...
export async function getPublicVapidKey(){
  const res = await fetch(`api/push-notifications/get-public-vapid-key`);
